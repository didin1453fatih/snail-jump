 ...
 * @return {!proto.greeter.HelloRequest} The clone.
 */
proto.greeter.HelloRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.greeter.HelloRequest} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.greeter.HelloResponse.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getMessage();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.greeter.HelloResponse} The clone.
 */
proto.greeter.HelloResponse.prototype.cloneMessage = function() {
  return /** @type {!proto.greeter.HelloResponse} */ (jspb.Message.cloneMessage(this));
};
